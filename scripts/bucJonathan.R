...
plot(log(longevity), r_expression_ENcP, sub=cor.test(log(longevity), r_expression_ENcP)$p.val, main=(cor.test(log(longevity), r_expression_ENcP, method="kendall")$estimate)^2, bg='grey60', pch=21, cex=1.5)
...
dev.print(pdf,'longevityBuc.pdf')
